...
void Seesaw_Training_3L_700Seesaw( TString myMethodList = "" )
{
   ...
   TString outfileName( "class_perf/Seesaw_3L_700Seesaw_Skims.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "Seesaw_3L_700Seesaw_Skims", outputFile,
   ...
   //factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize QQQ","!H:!V:NTrees=200:MinNodeSize=QQQ%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=2" );
   ...
   //factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage QQQ","!H:!V:NTrees=200:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=QQQ:nCuts=20:MaxDepth=2" );
   ...
   factory->BookMethod( dl, TMVA::Types::kBDT, "BDT","!H:!V:NTrees=25:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=.8:nCuts=10:MaxDepth=2" );

   //factory->BookMethod( dl, TMVA::Types::kBDT, "NCutsQQQ","!H:!V:NTrees=200:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.5:nCuts=QQQ:MaxDepth=2" );
