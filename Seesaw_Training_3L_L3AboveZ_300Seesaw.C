...
void Seesaw_Training_3L_L3AboveZ_300Seesaw( TString myMethodList = "" )
{
   ...
   TString outfileName( "class_perf/Seesaw_3L_300Seesaw_L3AboveZ_Skims.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "Seesaw_3L_300Seesaw_L3AboveZ_Skims", outputFile,
   ...
   TCut mycuts = "L3Bins27_0_<25&&L3Bins27_0_>20";

   TCut mycutb = "L3Bins27_0_<25&&L3Bins27_0_>20";
   ...
   dl->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=5000:nTrain_Background=25000:SplitMode=Random:NormMode=NumEvents:!V" );
   ...
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .1","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.1:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .3","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .5","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .8","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.8:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage 1.0","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=1.0:nCuts=20:MaxDepth=2" );
   
   factory->BookMethod( dl, TMVA::Types::kBDT, "BDT","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=2" );
   ...
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 10","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.5:nCuts=2:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 30","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.5:nCuts=5:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 50","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.5:nCuts=10:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 80","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 100","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.5:nCuts=100:MaxDepth=2" );
