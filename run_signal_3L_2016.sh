...
cp Application_2016_signal.C outFiles/Application_$1/$2/Application_2016_signal.C
sed -i "s/QQQ/$2/g;" outFiles/Application_$1/$2/Application_2016_signal.C
sed -i "s/JJJ/$1/g;" outFiles/Application_$1/$2/Application_2016_signal.C
root -l -q outFiles/Application_$1/$2/Application_2016_signal.C