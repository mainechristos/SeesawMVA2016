...
void Seesaw_Training_3L_300Seesaw( TString myMethodList = "" )
{
   ...
   TString outfileName( "class_perf/Seesaw_3L_300Seesaw_Skims.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "Seesaw_3L_300Seesaw_Skims", outputFile,
   ...
   TFile *sig_input = TFile::Open( "/cms/mchristos/ANN/Seesaw/2016/Seesaw_2_16_19/SignalTree300.root" );     //opens signal file matching process name
   ...
   //factory->BookMethod( dl, TMVA::Types::kBDT, "Depth QQQ","!H:!V:NTrees=300:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=QQQ" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Depth 1","!H:!V:NTrees=100:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Depth 2","!H:!V:NTrees=100:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Depth 3","!H:!V:NTrees=100:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Depth 4","!H:!V:NTrees=100:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=4" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Depth 5","!H:!V:NTrees=100:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=5" );
   
   
   //actory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize QQQ","!H:!V:NTrees=300:MinNodeSize=QQQ%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize 1.0","!H:!V:NTrees=100:MinNodeSize=1.0%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize 2.0","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize 3.0","!H:!V:NTrees=100:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize 5.0","!H:!V:NTrees=100:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize 10.0","!H:!V:NTrees=100:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   
   //factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage QQQ","!H:!V:NTrees=300:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=QQQ:nCuts=20:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .1","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .3","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .5","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .8","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.8:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage 1.0","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=1.0:nCuts=20:MaxDepth=1" );
   
   factory->BookMethod( dl, TMVA::Types::kBDT, "BDT","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=1" );

   //factory->BookMethod( dl, TMVA::Types::kBDT, "NCutsQQQ","!H:!V:NTrees=300:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.5:nCuts=QQQ:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 10","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.5:nCuts=2:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 30","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.5:nCuts=5:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 50","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.5:nCuts=10:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 80","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 100","!H:!V:NTrees=100:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.5:nCuts=100:MaxDepth=1" );
