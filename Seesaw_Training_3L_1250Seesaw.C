...
void Seesaw_Training_3L_1250Seesaw( TString myMethodList = "" )
{
   ...
   TString outfileName( "class_perf/Seesaw_3L_1250Seesaw_Skims.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "Seesaw_3L_1250Seesaw_Skims", outputFile,
   ...
   //factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize QQQ","!H:!V:NTrees=50:MinNodeSize=QQQ%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=3" );
   ...
   //factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage QQQ","!H:!V:NTrees=50:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=QQQ:nCuts=20:MaxDepth=3" );
   ...
   factory->BookMethod( dl, TMVA::Types::kBDT, "BDT","!H:!V:NTrees=25:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=3" );

   //factory->BookMethod( dl, TMVA::Types::kBDT, "NCutsQQQ","!H:!V:NTrees=50:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=.5:nCuts=QQQ:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 10","!H:!V:NTrees=25:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=.5:nCuts=2:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 30","!H:!V:NTrees=25:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=.5:nCuts=5:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 50","!H:!V:NTrees=25:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=.5:nCuts=10:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 80","!H:!V:NTrees=25:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 100","!H:!V:NTrees=25:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=.5:nCuts=100:MaxDepth=3" );
