...
void Seesaw_Training_3L_L3BelowZ_300Seesaw( TString myMethodList = "" )
{
   ...
   gROOT->ProcessLineSync(".L /cms/mchristos/ANN/Seesaw/2016/custom_functions/inputVars8.C");
   ...
   TString outfileName( "class_perf/Seesaw_3L_300Seesaw_L3BelowZ_Skims.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "Seesaw_3L_300Seesaw_L3BelowZ_Skims", outputFile,
   ...
   TCut mycuts = "L3Bins27_0_<21&&L3Bins27_0_>16";

   TCut mycutb = "L3Bins27_0_<21&&L3Bins27_0_>16";
   ...
   dl->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=1000:nTrain_Background=45000:SplitMode=Random:NormMode=NumEvents:!V" );
   ...
   // //factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize QQQ","!H:!V:NTrees=300:MinNodeSize=QQQ%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize 1.0","!H:!V:NTrees=25:MinNodeSize=1.0%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize 2.0","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize 3.0","!H:!V:NTrees=25:MinNodeSize=3.0%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize 5.0","!H:!V:NTrees=25:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "MinNodeSize 10.0","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=1:nCuts=20:MaxDepth=1" );
   ...
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .1","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.1:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .3","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .5","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .8","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.8:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage 1.0","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=1.0:nCuts=20:MaxDepth=1" );
   
   factory->BookMethod( dl, TMVA::Types::kBDT, "BDTog","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=1" );
   factory->BookMethod( dl, TMVA::Types::kBDT, "BDTtest1","!H:!V:NTrees=20:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=2" );
   factory->BookMethod( dl, TMVA::Types::kBDT, "BDT","!H:!V:NTrees=25:MinNodeSize=5.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=2" );

   // //factory->BookMethod( dl, TMVA::Types::kBDT, "NCutsQQQ","!H:!V:NTrees=100:MinNodeSize=1.0%:BoostType=Grad:Shrinkage=.8:nCuts=QQQ:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 10","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.3:nCuts=2:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 30","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.3:nCuts=5:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 50","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.3:nCuts=10:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 80","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=1" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 100","!H:!V:NTrees=25:MinNodeSize=2.0%:BoostType=Grad:Shrinkage=.3:nCuts=100:MaxDepth=1" );
