...
void runBackground(TString ifile = ""){
   ...
   TFile *endfile = new TFile("outFiles/Application_1/ttbar1L_Input_13/BDTtree.root","RECREATE");   
...
{   
   ...
   TString back_name = "/cms/heindl/software/pyPlotter/runPlotter_3L_NewSuperskims_2016/InputBundle_ttbar1L_Input_13_Tree.root";
