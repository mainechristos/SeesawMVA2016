...
void runBackground(TString ifile = ""){
   ...
   TFile *endfile = new TFile("outFiles/Application_1/ZZ2L2Nu_Input_49/BDTtree.root","RECREATE");   
...
{   
   ...
   TString back_name = "/cms/heindl/software/pyPlotter/runPlotter_3L_NewSuperskims_2016/InputBundle_ZZ2L2Nu_Input_49_Tree.root";
