...
void runBackground(TString ifile = ""){
   ...
   TFile *endfile = new TFile("outFiles/Application_1/top_Input_70/BDTtree.root","RECREATE");   
...
{   
   ...
   TString back_name = "/cms/heindl/software/pyPlotter/runPlotter_3L_NewSuperskims_2016/InputBundle_top_Input_70_Tree.root";
