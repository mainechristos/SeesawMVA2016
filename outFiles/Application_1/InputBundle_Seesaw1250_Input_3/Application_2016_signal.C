...
void runBackground(TString ifile = ""){
   ...
   reader1->BookMVA( "BDTG method",  "dl/weights/Seesaw_3L_300Seesaw_Skims_BDT.weights.xml");
   reader2->BookMVA( "BDTG method",  "dl/weights/Seesaw_3L_700Seesaw_Skims_BDT.weights.xml");
   reader3->BookMVA( "BDTG method",  "dl/weights/Seesaw_3L_1250Seesaw_Skims_BDT.weights.xml");
   ...
   TFile *endfile = new TFile("outFiles/Application_1/InputBundle_Seesaw1250_Input_3/BDTtree.root","RECREATE");   
...
void Application_2016_signal( TString myMethodList = "" ) 
{   
   ...
   TString back_name = "/cms/mchristos/software/CMSSW_10_3_ROOT614_X_2018-09-16-0000/pyPlotterSeesaw/pyplotter/runPlotter_3L_SeesawSR_NTuplePlotter_2016_MakeSkims/InputBundle_Seesaw1250_Input_3_Tree.root";
