...
void Seesaw_Training_3L_L3OSSF0_300Seesaw( TString myMethodList = "" )
{
   ...
   TString outfileName( "class_perf/Seesaw_3L_300Seesaw_L3OSSF0_Skims.root" );
   TFile* outputFile = TFile::Open( outfileName, "RECREATE" );

   TMVA::Factory *factory = new TMVA::Factory( "Seesaw_3L_300Seesaw_L3OSSF0_Skims", outputFile,
   ...
   TFile *sig_input = TFile::Open( "/cms/mchristos/ANN/Seesaw/2016/Seesaw_2_16_19/SignalTree300L3OSSF0.root" );     //opens signal file matching process name
   ...
   TFile *back_input = TFile::Open( "/cms/mchristos/ANN/Seesaw/2016/Seesaw_2_16_19/BackgroundTreeL3OSSF0.root" );     //opens background file matching process name
   ...
   dl->PrepareTrainingAndTestTree( mycuts, mycutb,
                                        "nTrain_Signal=2800:nTrain_Background=11008:SplitMode=Random:NormMode=NumEvents:!V" );
   ...
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .1","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.1:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .3","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .5","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage .8","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.8:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "Shrinkage 1.0","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=1.0:nCuts=20:MaxDepth=2" );
   
   // factory->BookMethod( dl, TMVA::Types::kBDT, "BDT1","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=2" );
   factory->BookMethod( dl, TMVA::Types::kBDT, "BDT","!H:!V:NTrees=50:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "BDT3","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=3" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "BDT4","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.5:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "BDT5","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.8:nCuts=20:MaxDepth=2" );
   ...
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 10","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.3:nCuts=2:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 30","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.3:nCuts=5:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 50","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.3:nCuts=10:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 80","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.3:nCuts=20:MaxDepth=2" );
   // factory->BookMethod( dl, TMVA::Types::kBDT, "NCuts 100","!H:!V:NTrees=25:MinNodeSize=10.0%:BoostType=Grad:Shrinkage=.3:nCuts=100:MaxDepth=2" );
